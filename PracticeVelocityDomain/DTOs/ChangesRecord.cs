...
namespace PracticeVelocityDomain.DTOs.Changes
{
    ...
    [XmlRoot(ElementName = "PvPayerInformation")]
    ...
    [XmlRoot(ElementName = "PvPatientDocument")]
    public class PatientDocument
    {
        ...
        [XmlElement(ElementName = "PvPatientDocument")]
    ...
    public class Chart
    {
        ...
        [XmlElement(ElementName = "PvChartDocument")]
    ...
    {
        [XmlElement(ElementName = "PvPayerInformation")]
        ...
        [XmlAttribute(AttributeName = "Pat_Phone")]
        public string Pat_Phone { get; set; }
        [XmlAttribute(AttributeName = "Proc_Codes")]
        public string Proc_Codes { get; set; }
    }

    [XmlRoot(ElementName = "Log_Record_Changes")]
    public class Log_Record_Changes
    {
